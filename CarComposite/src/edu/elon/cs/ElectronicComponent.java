/**
 * ElectronicComponent.java 1.0 Oct 28, 2014
 *
 ...
 *
 */
public class ElectronicComponent extends CarComponent  {
  ArrayList<CarComponent> carComponents = new ArrayList<CarComponent>(); 
  String electronicComponents;
  
  public ElectronicComponent(String electronicComponents){
